...
from bullyguard.config_schemas.tokenizer_training_config_schema import TokenizerTrainingConfig
...
@get_pickle_config(config_path="bullyguard/configs/automatically_generated", config_name="tokenizer_training_config")
